...
const CONTRACT_ADDRESSES = {
  ...
  mainnet: {
    ...
    USDC_XDC: '0xfA2958CB79b0491CC627c1557F441eF849Ca8eb1',
    ...
    MESSAGE_TRANSMITTER_XDC: '0x81D40F21F12A8F0E3252Bccb954D722d4c464B64'
  }
};
...
module.exports = {
  ...
  LOWJC_XDC_ADDRESS: getContractAddress('LOWJC_XDC'),
  LOCAL_ATHENA_XDC_ADDRESS: getContractAddress('LOCAL_ATHENA_XDC'),
  LOCAL_BRIDGE_XDC_ADDRESS: getContractAddress('LOCAL_BRIDGE_XDC'),
  CCTP_ARB_ADDRESS: getContractAddress('CCTP_ARB'),
  CCTP_OP_ADDRESS: getContractAddress('CCTP_OP'),
  CCTP_XDC_ADDRESS: getContractAddress('CCTP_XDC'),
  ...
  MESSAGE_TRANSMITTER_XDC: getContractAddress('MESSAGE_TRANSMITTER_XDC'),
