    ...
    <>
      ...
      <div className="release-payment-container" style={{width:536}}>
        ...
        <div className="form-header">
            ...
            <div className="titleText" style={{fontSize:20}}>Member Recruitment Application</div>
          ...
          <div className="form-body">
            ...
            <div className="profile-about-item">
                ...
                <div className="profile-about-content">
                    <span>personsname@email.com</span>
                </div>
            </div>
            <div className="profile-about-item">
            ...
            <div className="detail-row">
                <span className="detail-label">REASON FOR RECRUITMENT</span>
            ...
            <div className="form-groupDC" style={{marginBottom:6}}>
