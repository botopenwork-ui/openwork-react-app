...
export default function JoineeApplication() {
    ...
    <>
      ...
      <div className="release-payment-container">
        ...
        <div className="form-header">
          <BackButton to={`/job-update`} style={{gap: '20px'}} title="UX Skill Oracle Application"/>
          ...
          <div className="form-body">
            ...
            <div>
                <div className="apply-introduction">
                    <span>I'm a Product Designer based in Melbourne, Australia. I enjoy working on product design, design systems, and Webflow projects, but I don't take myself too seriously.</span>
                    <span>I’ve worked with some of the world’s most exciting companies, including Coinbase, Stripe, and Linear. I'm passionate about helping startups grow, improve their UX and customer experience, and to raise venture capital through good design.</span>
                </div>
            </div>
            <div>
